...
class sdwac_Setting
{
    ...
    public function sdwac_coupon_menu_items()
    {
        ...
        // add_submenu_page('sdwac_coupon-addons', 'WooCoupons', 'Coupons', 'manage_options', $post_type_link);
        add_submenu_page('springdevs-addons', 'WooCoupon settings', 'Settings', "manage_options", 'woocoupon_settings', [$this, 'woocoupon_settings_content']);
    }
                        ...
                        <tr>
                            <th scope="row">
                                <label for="sdwac_first_time_purchase_coupon">
                                    <?php _e('Coupon for first Purchase', 'springdevs_wma'); ?>
                                </label>
                            </th>
                            <td class="forminp forminp-select">
                                ...
                                <p class="description"><?php _e('Select a discount from here which you want to enable for new customers', 'springdevs_wma'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                                <label for="sdwac_first_time_purchase_coupon_label">
                                    <?php _e('First Purchase coupon label', 'springdevs_wma'); ?>
                                </label>
                            </th>
                            <td>
                                ...
                                <p class="description"><?php _e('Display Label on cart', 'springdevs_wma'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                                <label for="sdwac_show_product_discount">
                                    <?php _e('Show Product Discount', 'springdevs_wma'); ?>
                                </label>
                            </th>
                            <td>
                                ...
                                <p class="description"><?php _e('Set "no" , if you want to hide product discount', 'springdevs_wma'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                                <label for="sdwac_multi">
                                    <?php _e('Multi Coupon', 'springdevs_wma'); ?>
                                </label>
                            </th>
                            <td>
                                ...
                                <p class="description"><?php _e('Set "no" , if you never want to apply Multi coupon in cart', 'springdevs_wma'); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                                <label for="sdwac_url">
                                    <?php _e('Coupon Url slug Name', 'springdevs_wma'); ?>
                                </label>
                            </th>
                            <td>
